...
- **App port:** 7700
- **Gateway:** nginx reverse proxy on port 8080 (path-based routing, config at `/Users/minyic/gateway/`)
- **Funnel URL:** `https://minyis-mac-mini.tail564b26.ts.net` (Tailscale Funnel → nginx:8080 → claude-hub:7700)
